...
<%
	...
	try{
		...
		dbcon.getConnection();
		PreparedStatement ps2=dbcon.con.prepareStatement("select unf from signuptable");
		...
		ps=dbcon.con.prepareStatement("insert into signuptable(namef,unf,pwf,mailf,dayf,monthf,yearf,companyf,statusf) values(?,?,?,?,?,?,?,?,?)");
		...
		out.println("but you are to be verified to login");
