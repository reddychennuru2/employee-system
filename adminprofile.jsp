...
<div style="position:absolute;left:400px;top:80">
	...
	<%
		...
		{
			dbcon.getConnection();
			ps1=dbcon.con.prepareStatement("select * from adminsignuptable where unf=?");
	...
	%>
		...
		<table>
		<tr>
		<th align=left width="170px"><font size=5 color="brown">Birthday</font>
		<td><font size=5 color="brown"><%=day%><%out.println("/");%></font>
		
		<td><font size=5 color="brown"><%=month%><%out.println("/");%></font>
		<td><font size=5 color="brown"><%=year%></font>
		</table>
</div>
	</body>
