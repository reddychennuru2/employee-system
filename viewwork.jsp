...
<%
	try{
	 	dbcon.getConnection();
		ps1=dbcon.con.prepareStatement("select * from workt");
		rs=ps1.executeQuery();%>
		<table border="1">
		<tr>
		<th width="100px" height="100px"><font color="brown" size="5">PROJECT</font>
		<th width="100px"><font color="brown" size="5">WORK EXPERIENCE</font>
		...
		{%>
			...
			<tr>
			<td width="100px" height="100px"><font color="brown" size="3"><%=rs.getString("pnamef")%></font>
